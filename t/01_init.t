...
throws_ok { Mojo::Redis::Processor->new({data => 'DATA'}) } qr/Error, missing parameters: trigger/, 'setting data will suggest it is a process requestor and needs to set a trigger';
